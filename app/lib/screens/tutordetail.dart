...
class DetailPage extends StatefulWidget {
  static const routeName = '/tutorsPage';
...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // final loadedTutor = Provider.of<TutorProvider>(context);
    final tutorsData = Provider.of<TutorProvider>(context);
    final loadedTutor = tutorsData.findById(tutorId);
    final cart = Provider.of<cartProvider>(context);
    return Scaffold(
        backgroundColor: Color(0xffe7f4f5),
        appBar: AppBar(
          title: Text(loadedTutor.tutor_name),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Courses by ${loadedTutor.tutor_name}",
                            style: TextStyle(
                                fontWeight: FontWeight.w700,
                                fontSize: 17,
                                fontFamily: 'product'),
                            ...
                            child: Container(
                                ...
                                child: MaterialButton(
                                  onPressed: () {
                                    ...
                                    cart.additem(tutorId, loadedTutor.tutor_name, loadedTutor.price);
                                    // lipanampesa();
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(loadedTutor.profile_image),
                    fit: BoxFit.contain)),
          )
        ],
      ),
